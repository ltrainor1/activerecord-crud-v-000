...
def can_find_by_multiple_attributes
  Movie.where([]"title = :title and release_date = :release_date and director = :director", {title: "Title", release_date: 2000, director: "Me"}])
  # title == "Title"
  # release_date == 2000
  # director == "Me"
  __
...
def can_update_using_update_method
  ...
  Movie.update(:title, "Wat", "Wat, huh?")
end
